...
export const CAPTCHA_TEXT =
  /\b(captcha|recaptcha|hcaptcha|cf-turnstile|verify you are human|are you a robot)\b/i;

export const TWO_FACTOR_TEXT =
  /\b(two[- ]factor|2fa|authenticator|enter (the )?code|sms code|one[- ]time password|otp)\b/i;
